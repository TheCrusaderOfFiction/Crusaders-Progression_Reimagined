...
import net.wolfygames7237.crusadersprogressionreimagined.screen.ModMenuTypes;
...
@Mod(CrusadersProgressionReimagined.MOD_ID)
public class CrusadersProgressionReimagined
{
    public static final String MOD_ID = "crusadersprogressionreimagined";
