...
public class ModToolTiers {
    ...
    public static final Tier MOD_WOOD = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation("crusadersprogressionreimagined", "wood"),
            List.of(), List.of());
    public static final Tier MOD_STONE = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation("crusadersprogressionreimagined", "stone"),
    ...
    public static final Tier COPPER = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation("crusadersprogressionreimagined", "copper"),
    ...
    public static final Tier MOD_IRON = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation("crusadersprogressionreimagined", "iron"),
    ...
    public static final Tier MOD_DIAMOND = TierSortingRegistry.registerTier(
            ...
            new ResourceLocation("crusadersprogressionreimagined", "diamond"),
