...
import net.wolfygames7237.crusadersprogressionreimagined.datagen.custom.ForgeRecipeBuilder;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        new ForgeRecipeBuilder(ModItem.IRON_PICKAXE_HEAD.get(), 1)
                ...
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "iron_pickaxe_top_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.IRON_SHOVEL_BLADE.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.COPPER_HAMMER.get()))
                .unlockedBy("has_iron", has(Items.IRON_INGOT))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "iron_shovel_2_forge"));
        new ForgeRecipeBuilder(ModItem.IRON_SHOVEL_BLADE.get(), 1)
                .setIngredient(0, Ingredient.of(Items.IRON_INGOT))
                // ... other slots ...
                .setFuel(Ingredient.of(Items.COAL))
                .setTool(Ingredient.of(ModItem.COPPER_HAMMER.get()))
                .unlockedBy("has_iron", has(Items.IRON_INGOT))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "iron_shovel_1_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.IRON_HOE_BLADE.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.COPPER_HAMMER.get()))
                .unlockedBy("has_iron", has(Items.IRON_INGOT))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "iron_hoe_top_left_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.IRON_AXE_HEAD.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.COPPER_HAMMER.get()))
                .unlockedBy("has_iron", has(Items.IRON_INGOT))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "iron_axe_top_left_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.IRON_SWORD_BLADE.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.COPPER_HAMMER.get()))
                .unlockedBy("has_iron", has(Items.IRON_INGOT))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "iron_sword_top_left_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.DIAMOND_PICKAXE_HEAD.get(), 1)
                ...
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "diamond_pickaxe_top_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.DIAMOND_SHOVEL_BLADE.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.IRON_HAMMER.get()))
                .unlockedBy("has_diamond", has(Items.DIAMOND))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "diamond_shovel_2_forge"));
        new ForgeRecipeBuilder(ModItem.DIAMOND_SHOVEL_BLADE.get(), 1)
                .setIngredient(0, Ingredient.of(Items.DIAMOND))
                // ... other slots ...
                .setFuel(Ingredient.of(ModBlocks.CHARGED_COAL_BLOCK.get()))
                .setTool(Ingredient.of(ModItem.IRON_HAMMER.get()))
                .unlockedBy("has_diamond", has(Items.DIAMOND))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "diamond_shovel_1_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.DIAMOND_HOE_BLADE.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.IRON_HAMMER.get()))
                .unlockedBy("has_diamond", has(Items.DIAMOND))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "diamond_hoe_top_left_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.DIAMOND_AXE_HEAD.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.IRON_HAMMER.get()))
                .unlockedBy("has_diamond", has(Items.DIAMOND))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "diamond_axe_top_left_forge"));
        ...
        new ForgeRecipeBuilder(ModItem.DIAMOND_SWORD_BLADE.get(), 1)
                ...
                .setTool(Ingredient.of(ModItem.IRON_HAMMER.get()))
                .unlockedBy("has_diamond", has(Items.DIAMOND))
                .save(pWriter, new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "diamond_sword_top_left_forge"));
    ...
    private static ResourceLocation recipes(String name) {
        return new ResourceLocation("crusadersprogressionreimagined", name);
    }
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult,
                    ...
                    .save(pFinishedRecipeConsumer,  CrusadersProgressionReimagined.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
    }
