package net.wolfygames7237.crusadersprogressionreimagined.blocks;
...
import net.wolfygames7237.crusadersprogressionreimagined.blocks.custom.Forge;

import java.util.function.Supplier;

public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, CrusadersProgressionReimagined.MOD_ID);
