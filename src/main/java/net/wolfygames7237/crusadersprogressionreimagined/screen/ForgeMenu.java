package net.wolfygames7237.crusadersprogressionreimagined.screen;
...
import net.wolfygames7237.crusadersprogressionreimagined.entity.ForgeBlockEntity;
...
public class ForgeMenu extends AbstractContainerMenu {
    ...
    public ForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 34, 14));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 52, 14));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 70, 14));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 34, 32));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 52, 32));
            this.addSlot(new SlotItemHandler(iItemHandler, 5, 70, 32));
