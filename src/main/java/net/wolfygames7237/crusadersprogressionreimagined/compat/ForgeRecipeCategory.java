...
public class ForgeRecipeCategory implements IRecipeCategory<ForgeRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "forge");
    public static final ResourceLocation TEXTURE = new ResourceLocation(CrusadersProgressionReimagined.MOD_ID,
