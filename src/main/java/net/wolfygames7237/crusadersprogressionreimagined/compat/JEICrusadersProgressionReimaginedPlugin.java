...
import net.wolfygames7237.crusadersprogressionreimagined.recipe.ForgeRecipe;
import net.wolfygames7237.crusadersprogressionreimagined.screen.ForgeScreen;

import java.util.List;

@JeiPlugin
public class JEICrusadersProgressionReimaginedPlugin implements IModPlugin {

    @Override
    public ResourceLocation getPluginUid() {
        return new ResourceLocation(CrusadersProgressionReimagined.MOD_ID, "jei_plugin");
    }
